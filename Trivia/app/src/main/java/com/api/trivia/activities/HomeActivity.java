...
public class HomeActivity extends Activity {
    ...
    private void sendEmail(){
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "Answers Questions");
    ...
    private void getQuestions() {
        alert.show();
        service.getSaveGames(Constants.BASE_AMOUNT,Constants.BASE_CATEGORY,Constants.BASE_DIFFICULTY).enqueue(new Callback<Result>() {
            @Override
    ...
    private void getQuestions(final int amount, final String category, final String difficulty) {
        alert.show();
        service.getSaveGames(amount,category,difficulty).enqueue(new Callback<Result>() {
            @Override
            public void onResponse(Call<Result> call, Response<Result> response) {
                createViewQuestions(response.body().getResults());
            }
